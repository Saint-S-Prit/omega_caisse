                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      productList.length > productLimitToAddSearchWidget
                          ? Padding(
                              padding:
                          ...
                          child: GridView.builder(
                            ...
                            itemBuilder: (context, index) {
                              if (index < filteredProducts.length) {
                                return Container(
                                    color: Colors
                                        .transparent, // Ajouté pour s'assurer qu'il y a une zone de détection
                                    child: ProductCard(
                      ...
                      BlocBuilder<CartBloc, CartState>(
                        builder: (context, state) {
                          return state.cartItems.isNotEmpty
                              ? Container(
                                  decoration:
                                      TextStyles.boxDecorationCustomer(context),
                                  child: Padding(
